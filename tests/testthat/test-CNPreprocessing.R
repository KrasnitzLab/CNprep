...
weightExample <- matrix(data = c(0.512212, 0.392772, 0.434267, 0.493263, 0.488931, 
                                 0.377457, 0.494703, 0.177088, 0.227386, 0.492717, 
                                 0.555187, 0.568054, 0.585616, 0.426607, 0.558966, 
                                 0.676231, 0.179728, 0.666528, 0.844281, 0.642988, 
                                 0.790807, 0.612881, 0.816053, 0.708305, 0.552298, 
                                 0.721812, 0.684443, 0.700101, 0.737285, 0.778402, 
                                 0.748436, 0.656391, 0.533381, 0.786814, 0.837422, 
                                 0.629526, 0.727452, 0.635297, 0.571190, 0.595246, 
                                 0.790430, 0.829967, 0.559348, 0.633930, 0.579300, 
                                 0.728961, 0.696930, 0.788638, 0.782530, 0.712650), ncol = 1)

colnames(weightExample) <- c("WZ2")

weightExample1 <- weightExample
colnames(weightExample1) <- c("WZ1")
...
test_that("CNpreprocessing() with weight must return expected results 04", {
    ...
    expected$segmedian <- c(0.0866247522599, 0.0731923745507, 0.0768954423655, -0.0073122998188, 0.0281455710909)
    expected$segmad <- c(0.0640420794887, 0.0476423308181, 0.0883320199799, 0.0410240773199, 0.0752964600184)
    expected$mediandev <- c(0.0669544866643, 0.0535221089551, 0.0572251767699, -0.0269825654144, 0.0084753054954)
    expected$segerr <- as.double(rep(NA, 5))
    expected$centerz <- c(0.0000000000000, 0.0000000000000, 0.0000000000000, 1.0000000000000, 1.0000000000000)
    expected$marginalprob <- c(0.0000000000000, 0.0000000000000, 0.0000000000000, 0.0000000000000, 0.0000630376547)
    expected$maxz <- c(0.9999999999999, 1.0000000000000, 1.0000000000000, 1.0000000000000, 1.0000000000000)
    expected$maxzmean <- c(0.0472990954868, 0.0481891718632, 0.0388593672190, 0.0000000000000, 0.0000000000000)
    expected$maxzsigma <- c(0.0001142288631, 0.0001142288631, 0.0001142288631, 0.0110507019420, 0.0110507019420)
    expected$samplesize <- c(111, 75, 41, 67, 42)
    expected$negtail <- c(1.0000000000000, 1.0000000000000, 1.0000000000000, 0.0003729367619, 0.9913913578726)
    row.names(expected) <- NULL
