...
test_that("breakIntoGaps() must return expected results 01", {
    ...
    expected <- matrix(c(1, 13, 22, 25, 38, 12, 24, 30, 37, 50), ncol=2, byrow = FALSE)
...
test_that("breakIntoGaps() must return expected results 02", {
    ...
    expected <- matrix(c(1, 1, 22, 24, 38, 12, 23, 30, 50, 50), ncol=2, byrow = FALSE)
    colnames(expected) <- c("start", "end")
    
    expect_equal(results, expected)
})

test_that("breakIntoGaps() must return expected results when no segment to remove", {
    ...
    expected <- matrix(c(1, 13, 23, 31, 38, 12, 21, 30, 37, 50), ncol=2, byrow = FALSE)
    colnames(expected) <- c("start", "end")
