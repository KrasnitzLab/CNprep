...
which somatic alterations occur, is uneasy [@Kendall2011].
...
1. a table of copy number events with genomic positions
...
the *makeCNPmask()* function for this dataset when the lower threshold is set 
to 0.25 and upper threshold to 0.45.
...
complexe dataset of 1203 samples.
