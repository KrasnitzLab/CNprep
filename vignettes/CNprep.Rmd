...
are distributed under the [GPL-2 License](https://www.gnu.org/licenses/old-licenses/gpl-2.0.txt). You are free to use and redistribute this software. 
...
more, CNVs can potentially be used as biomarker for cancer 
diagnosis [@Pan2018].
